...
- [x] **APIキーローテーションの信頼性向上** ✅ (2026-02-01 完了)
  - 枯渇状態（429）のディスク永続化によるプロセス間共有
  - DreamingManager（睡眠モード）への自動ローテーション・再試行ロジック追加
  - ローテーション後の選択キー名保存漏れ・タイポ修正
  - 関連: [レポート](../reports/2026-02-01_api_key_rotation_reliability.md)
