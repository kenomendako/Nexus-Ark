...
|------|------|
| uv による環境管理 | ✅ |
| Zip + PowerShellランチャー配布 | ✅ |
| start.sh の uv 自動インストール | ✅ |
| Start.bat の uv 自動インストール | ✅ |
...
| [x] マイグレーションツール | 既存ユーザーのデータ移行（実装・検証完了、オンボーディングUI統合済） |
| [x] 軽量配布テスト | Zip配布 + PowerShellランチャーでの起動確認 ✅ |
| [x] オンボーディング改善 | 新規/移行の選択、APIキー案内、自動リロード実装 ✅ |
