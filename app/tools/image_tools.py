...
def generate_image(prompt: str, room_name: str, api_key: str, api_key_name: str = None) -> str:
    ...
    print(f"--- 画像生成ツール実行 (Provider: {provider}, Model: {model_name}, Key: {api_key_name}, Prompt: '{prompt[:100]}...') ---")
...
def generate_image_caption(image_path: str, api_key_name: str = None) -> str:
    ...
    try:
        ...
        prompt = "この画像に何が写っているか、詳細に説明してください。誰が／何が、どこで、何をしていますか？色や形、雰囲気など、後からテキスト情報だけで画像を思い出せるように具体的な内容を含めてください。"
