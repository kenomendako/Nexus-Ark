...
try:
    ...
    .unified-inventory-table th,
    .unified-inventory-table td {
        padding: 8px 10px;
        border-bottom: 1px solid var(--border-color-primary);
        text-align: left;
        vertical-align: top;
    ...
    #chat_output_area .message-bubble:has(textarea),
    #chat_output_area .message-wrap .message:has(textarea),
    #chat_output_area .bubble-wrap:has(textarea) {
        width: min(100%, 760px) !important;
        max-width: min(100%, 760px) !important;
    }
    #chat_output_area textarea,
    #chat_output_area [contenteditable="true"] {
        width: 100% !important;
    ...
    #chat_output_area .image-preview {
        position: fixed !important;
        inset: 0 !important;
    ...
    #chat_output_area .image-preview img,
    #chat_output_area .image-preview .preview {
    ...
    #chat_output_area :fullscreen .image-container,
    #chat_output_area :fullscreen .image-frame {
        width: 100vw !important;
        height: 100vh !important;
        display: flex !important;
        align-items: center !important;
    ...
    #chat_output_area :fullscreen .image-frame img,
    #chat_output_area :fullscreen img {
        width: auto !important;
        height: auto !important;
        max-width: calc(100vw - 32px) !important;
    ...
    #chat_output_area :-webkit-full-screen {
        width: 100vw !important;
        height: 100vh !important;
        overflow: hidden !important;
        background-color: #000 !important;
    ...
    #chat_output_area :-webkit-full-screen .image-container,
    #chat_output_area :-webkit-full-screen .image-frame {
        width: 100vw !important;
        height: 100vh !important;
        display: flex !important;
        align-items: center !important;
    ...
    #chat_output_area :-webkit-full-screen .image-frame img,
    #chat_output_area :-webkit-full-screen img {
        width: auto !important;
        height: auto !important;
        max-width: calc(100vw - 32px) !important;
        max-height: calc(100vh - 32px) !important;
...
""")
        ...
        custom_css = custom_css + "\n\n/* --- Initial room style: applied before demo.load --- */\n" + _style_tag_to_css(initial_room_style_css)
                        ...
                        with gr.TabItem("共通") as common_settings_tab:
                            ...
                            with gr.Accordion("📢 通知サービス設定", open=False):
                                notification_service_radio = gr.Radio(
                                    ...
                                    value=config_manager.CONFIG_GLOBAL.get("notification_service", "discord").capitalize(),
                                    interactive=True
                                )
                                gr.Markdown("---")
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("知識") as knowledge_tab:
                ...
                knowledge_file_list = gr.HTML(
                    "<p class='info-text'>知識ファイルはまだ読み込まれていません。</p>"
                )
                ...
                with gr.Row():
                    knowledge_refresh_button = gr.Button("一覧を更新", variant="secondary")
                            ...
                            with gr.TabItem("通常アイテム", id="std_item_placeholder_tab"):
                                ...
                                with gr.Accordion("📝 新規作成", open=True):
                                    ...
                                    with gr.Row():
                                        ...
                                        load_std_item_to_editor_button = gr.Button("📝 選択中のアイテムを読込", variant="secondary", scale=1)
            ...
            with gr.TabItem("外部接続") as external_connections_tab:
                with gr.Tabs():
                    with gr.TabItem("🐦 Twitter (X)", id="external_twitter_tab") as external_twitter_tab:
                        ...
                        with gr.Column(visible=not _twitter_accepted) as twitter_guard_panel:
                            ...
                            twitter_accept_button = gr.Button("規約とリスクを理解し、自己責任で利用を開始する", variant="primary")
                    ...
                    with gr.TabItem("💬 Discord Bot", id="external_discord_tab"):
                        _discord_accepted = config_manager.CONFIG_GLOBAL.get("accepted_disclaimers", {}).get("discord", False)
                        with gr.Column(visible=not _discord_accepted) as discord_guard_panel:
                            ...
                            discord_accept_button = gr.Button("規約とリスクを理解し、自己責任で利用を開始する", variant="primary")
                    ...
                    with gr.TabItem("📱 LINE 連携", id="external_line_tab"):
                        ...
                        with gr.Column(visible=not _line_accepted) as line_guard_panel:
                            ...
                            line_accept_button = gr.Button("規約とリスクを理解し、自己責任で利用を開始する", variant="primary")
        ...
        demo.load(
            ...
            show_progress_on=[chatbot_display]
        )
        ...
        refresh_scenery_button.click(
            ...
            show_progress_on=[current_scenery_display]
        )
        location_dropdown.change(
        ...
        notification_service_radio.change(fn=ui_handlers.handle_notification_service_change, inputs=[notification_service_radio], outputs=[common_settings_status])
        ...
        std_item_save_button.click(
            ...
            outputs=[std_item_status, unified_inventory_df, food_use_item_dropdown, inventory_status],
            show_progress="hidden",
            queue=False
        )
        ...
        food_item_save_button.click(
            ...
            outputs=[food_item_status, unified_inventory_df, food_use_item_dropdown, inventory_status],
            show_progress="hidden",
            queue=False
        )
...
# --- Multi-Provider Events ---
        ...
        twitter_accept_button.click(
            ...
            outputs=[twitter_guard_panel, twitter_main_content]
        )
        discord_accept_button.click(
            fn=ui_handlers.handle_accept_disclaimer,
            inputs=[gr.State("discord")],
            outputs=[discord_guard_panel, discord_main_content]
        )
        line_accept_button.click(
            fn=ui_handlers.handle_accept_disclaimer,
            inputs=[gr.State("line")],
            outputs=[line_guard_panel, line_main_content]
        )
