...
""")
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("アイテム") as item_root_tab:
                with gr.Tabs(selected="inventory_tab") as item_sub_tabs:
                    ...
                    with gr.TabItem("食べ物", id="food_item_tab", render_children=True):
                    ...
                    with gr.TabItem("通常アイテム", id="std_item_tab", render_children=True):
        ...
        inventory_edit_btn.click(
            ...
            inputs=[current_room_name, inventory_target_radio, inventory_selected_idx, inventory_selected_item_id],
            outputs=[
                inventory_status,
                # Food inputs (25)
        ...
        inventory_copy_btn.click(
            ...
            inputs=[current_room_name, inventory_target_radio, inventory_selected_idx, unified_inventory_df, inventory_selected_item_id],
