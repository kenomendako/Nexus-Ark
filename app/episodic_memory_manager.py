...
この日の出来事、そしてあなたの心の動きを、**後から自分自身が読み返してその時の感覚を再体験できるような「エピソード記憶」**として整理してください。
...
1. **本人視点（一人称）の内省スタイル**:
   ...
   - 相手とのやり取りは、あなたの目から見た事実、またはあなたの感じたこととして記せ。
2. **常体（だ・である調）の徹底**:
...
この会話の出来事とあなたの感情の動きを、**{char_limit}**、自分自身の備忘録として記述してください。
