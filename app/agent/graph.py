...
def safe_tool_executor(state: AgentState):
    ...
    if tool_name in ["plan_identity_memory_edit", "plan_diary_append", "plan_secret_diary_edit", "plan_notepad_edit", "plan_creative_notes_edit", "plan_research_notes_edit", "plan_world_edit"]:
        try:
            # ツール種別判定
